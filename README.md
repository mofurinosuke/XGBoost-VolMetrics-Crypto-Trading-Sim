...
## 📝 プロジェクト概要
このプロジェクトは、AIによるパターン認識（XGBoost）と、統計的な市場分析（GARCH、ADX、ボラティリティ収束則）を統合し、
...
【データの取り扱いについて】 本プロジェクトで使用した学習データおよびテストデータは、利用規約に基づき本リポジトリには含まれておりません。再現を希望される方は、各取引所のAPI等を通じて、ご自身で取得したデータをご使用ください。
## ✍️ 開発者
mofurinosuke
